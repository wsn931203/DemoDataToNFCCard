...
using System.Runtime.InteropServices;
	...
	public class ModWinsCard
	{
        ...
        [DllImport("winscard.dll")]
        public static extern int SCardControl(int hCard, int dwControlCode, ref byte SendBuff, int SendBuffLen, ref byte RecvBuff, int RecvBuffLen, ref int pcbBytesReturned);
